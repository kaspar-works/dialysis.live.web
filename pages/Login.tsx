...
import { signInWithEmail, signInWithGoogle, getIdToken, handleGoogleRedirect, isGoogleRedirectPending } from '../services/firebase';
  ...
  return (
    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 flex flex-col lg:flex-row animate-in fade-in duration-700 transition-colors">
      ...
      <div className="flex-1 p-12 lg:p-24 flex flex-col items-center justify-center relative">
        {/* Mobile/Explicit Back Home Link */}
        ...
        <div className="w-full max-w-md space-y-10">
           ...
           <div className="space-y-6">
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center pr-1">
                      <label className="text-[10px] font-black text-slate-400 dark:text-slate-600 uppercase tracking-widest ml-1">Password</label>
                      <Link to="/forgot-password" title="Recover Credentials" className="text-[10px] font-black text-sky-500 uppercase tracking-widest hover:text-sky-700">Forgot?</Link>
                  </div>
                  <input 
                    type="password" 
                    value={password}
              ...
              >
                 ...
                 <span className="font-black text-xs uppercase tracking-widest text-slate-700 dark:text-slate-300 group-hover:text-slate-900 dark:group-hover:text-white transition-colors">Continue with Google</span>
              </button>
           </div>

           <div className="text-center pt-4">
              <p className="text-sm font-bold text-slate-400">
                Don't have an account? <Link to="/register" className="text-sky-500 font-black hover:text-sky-700 transition-colors">Join Platform</Link>
              </p>
           </div>
        </div>
      </div>
