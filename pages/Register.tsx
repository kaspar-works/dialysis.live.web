...
const Register: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 flex flex-col lg:flex-row animate-in fade-in duration-700 transition-colors">
      ...
      />
      {/* Form Side */}
      <div className="flex-1 p-6 sm:p-8 md:p-12 lg:p-24 flex items-center justify-center order-2 lg:order-1 relative">
        {/* Back Home Link */}
      ...
      {/* Visual Side */}
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 p-12 lg:p-24 flex-col justify-between relative overflow-hidden order-1 lg:order-2">
