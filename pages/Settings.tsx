        ...
        {activeSection === 'security' && (
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-3">
              <Link to="/change-password" className="inline-flex items-center gap-2 px-4 py-2.5 bg-slate-100 dark:bg-white/5 hover:bg-slate-200 dark:hover:bg-white/10 rounded-xl text-sm font-semibold text-slate-700 dark:text-slate-300 transition-all">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
                Change Password
              </Link>
              <Link to="/two-factor" className="inline-flex items-center gap-2 px-4 py-2.5 bg-slate-100 dark:bg-white/5 hover:bg-slate-200 dark:hover:bg-white/10 rounded-xl text-sm font-semibold text-slate-700 dark:text-slate-300 transition-all">
